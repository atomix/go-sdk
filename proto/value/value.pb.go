...
func (m *SetRequest) GetHeader() *headers.SessionCommandHeader {
	if m != nil {
		return m.Header
	}
	return nil
...
func (m *SetResponse) GetHeader() *headers.SessionResponseHeader {
	if m != nil {
		return m.Header
	}
	return nil
...
func (m *CheckAndSetRequest) GetHeader() *headers.SessionCommandHeader {
	if m != nil {
		return m.Header
	}
	return nil
...
func (m *CheckAndSetResponse) GetHeader() *headers.SessionResponseHeader {
	if m != nil {
		return m.Header
	}
	return nil
...
var fileDescriptor_d92bdcec396f8bda = []byte{
	...
	,
}
