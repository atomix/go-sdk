...
func (m *atomicMapPrimitive[K, V]) decodeValue(key K, value *mapv1.Value) (*Entry[K, V], error) {
	if value == nil {
		return nil, nil
	}
...
func (m *atomicMapPrimitive[K, V]) decodeKeyValue(key string, value *mapv1.Value) (*Entry[K, V], error) {
