...
func (c *testMapServiceClient) Events(ctx context.Context, in *api.EventRequest, opts ...grpc.CallOption) (api.IndexedMapService_EventsClient, error) {
	panic("implement me")
}

func (c *testMapServiceClient) Entries(ctx context.Context, in *api.EntriesRequest, opts ...grpc.CallOption) (api.IndexedMapService_EntriesClient, error) {
	panic("implement me")
}
