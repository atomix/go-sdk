...
func New(ctx context.Context, name primitive.Name, partitions []*partition.Session) (IndexedMap, error) {
...
func newIndexedMap(ctx context.Context, name primitive.Name, session *partition.Session) (*indexedMap, error) {
