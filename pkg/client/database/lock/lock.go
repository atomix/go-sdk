...
func New(ctx context.Context, name primitive.Name, partitions []*partition.Session) (Lock, error) {
...
func newLock(ctx context.Context, name primitive.Name, session *partition.Session) (*lock, error) {
