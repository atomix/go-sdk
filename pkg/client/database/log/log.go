...
func New(ctx context.Context, name primitive.Name, partitions []*partition.Session) (Log, error) {
...
func newLog(ctx context.Context, name primitive.Name, session *partition.Session) (*log, error) {
